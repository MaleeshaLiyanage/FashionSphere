...
// Async thunk to add a product to the wait-list
export const addToWaitList = createAsyncThunk(
  "products/addToWaitList",
  async ({ productId }) => {
    const response = await axios.post(
      `${import.meta.env.VITE_BACKEND_URL}/api/products/wait-list`,
      { productId },
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("userToken")}`,
...
export const { setFilters, clearFilters, resetSelectedProduct } =
